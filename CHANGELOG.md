...
### Changed
- **Server Configuration**: Updated server to listen on `0.0.0.0:3000` to allow external connections
- **HTTPS Configuration**: Disabled HTTPS redirect in development/production mode when SSL certificates are not configured
- **Admin User**: Changed default admin login from `admin` to `elesh@cascata.ai`
- **Configure Cascata Environment Questions**: Improved clarity and consistency of all configuration questions:
  - Contacts section: Updated 4 questions with clearer, more professional wording
  - Deals section: Updated 6 questions with clearer, more professional wording
  - All questions now follow consistent "Which field..." format
